...
namespace MacomberMapCommunications.WCF
{
    ...
    /// </summary>
    [ServiceContract]
    public interface IMM_ConversationMessage_Types 
    {
        /// <summary>
        /// Receive a close client message
        /// </summary>
        ...
        [OperationContract(IsOneWay = true)]
        void ReceiveMessage(String Info, String MessageSource, MessageBoxIcon Icon);
        ...
        /// <returns></returns>
        [OperationContract(IsOneWay = true)]
        void UpdateLoadForecastData(MM_Load_Forecast_Data[] LoadData);
        ...
        /// <returns></returns>
        [OperationContract(IsOneWay = true)]
        void UpdateTransformerPhaseShifterData(MM_Transformer_PhaseShifter_Data[] PhaseShiftData);
        ...
        [OperationContract(IsOneWay = true)]
        void UpdateTieData(MM_Tie_Data[] TieData);
        ...
        /// <summary>
        /// Update our flowgate data
        /// </summary>
        /// <param name="StatusData"></param>
        [OperationContract(IsOneWay = true)]
        void UpdateFlowgateData(MM_Flowgate_Data[] flowgateData);
        ...
        /// <summary>
        /// Handle updating of the LMP data
        /// </summary>
        /// <param name="lmpData"></param>
        [OperationContract(IsOneWay = true)]
        void UpdateLmpData(MM_LMP_Data[] lmpData);
        ...
        /// <summary>
        /// Push updates to unit control status
        /// </summary>
        /// <param name="UnitStatus"></param>
        [OperationContract(IsOneWay = true)]
        void UpdateUnitControlStatus(MM_Unit_Control_Status[] UnitStatus);
    }
}
