...
namespace MacomberMap.UI.DgvFilterPopup
{
    ...
    public class DgvFilterManager {
        ...
        /// <summary>
        /// Occurs at the end of RebuildFilter().
        /// </summary>
        public event EventHandler FilterUpdated;
        protected virtual void OnFilterUpdated(object sender, EventArgs e)
        {
        ...
        public void RebuildFilter() {
            ...
            if (Filter != "") {
                ...
                Filter = (mBaseFilter == "") ? Filter : mBaseFilter + " AND " + Filter;
            }
            else
                Filter = mBaseFilter;
            ...
            } catch { System.Diagnostics.Debug.WriteLine ("Invalid filter: " + Filter);}
            OnFilterUpdated(this, new EventArgs());
        }
