...
namespace MacomberMap.UI
{
    ...
    /// </summary>
    [ToolboxItem(true), ToolboxBitmap(typeof(ScrollablePanel), "MacomberMap.UI.Icons.ScrollablePanelIco.png")]
    public class ScrollablePanel : System.Windows.Forms.Panel
    {
        ...
        private const int Wi_HSCROLL = 0x114;
        private const int Wi_VSCROLL = 0x115;
        private const int Wi_MOUSEWHEEL = 0x020A;
        private const int Wi_NCCALCSIZE = 0x0083;
        private const int Wi_PAINT = 0x000F;
        private const int Wi_SIZE = 0x0005;
        ...
        public void performScrollHorizontal(ScrollEventType type)
        {
            ...
            if (param == -1)
                return;
            SendMessage(this.Handle, (uint)Wi_HSCROLL, (System.UIntPtr)param, (System.IntPtr)0);
        }
        ...
        public void performScrollVertical(ScrollEventType type)
        {
            ...
            if (param == -1)
                return;
            SendMessage(this.Handle, (uint)Wi_VSCROLL, (System.UIntPtr)param, (System.IntPtr)0);
        }
