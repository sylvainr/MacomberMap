...
namespace MacomberMapClient.User_Interfaces.Summary
{
    ...
    /// </summary>
    public partial class MM_Element_Summary : ListView
    {
        ...
        private delegate void SafeSetControls(MM_DataSet_Base BaseData);
        ...
        protected override void OnMouseClick(MouseEventArgs e)
        {
            ...
            if (ht.Item != null && ht.Item.Text == "(get more...)")
            {
                ...
                //(TypeSelected.Target as MM_Form_Builder).Lasso_GetMoreElements();
            }
