...
namespace Macomber_Map.User_Interface_Components
{
    ...
    public partial class MM_Blackstart_Display : MM_Form
    {
        ...
        public DataSet_Base BaseData = new DataSet_Base("Blackstart");
        ...
        /// </summary>
        public MM_Blackstart_Display(Network_Map nMap)
        {
            InitializeComponent();
            this.nMap = nMap;
            ...
            olView.OneLineElementClicked += new OneLine_Viewer.OneLineElementClickedDelegate(OneLine_OneLineElementClicked);
        }
        ...
        /// <returns></returns>
        public static void CreateInstanceInSeparateThread(ToolStripMenuItem MenuItem, Network_Map nMap)
        {
        ...
        private static void InstantiateForm(object state)
        {
            ...
            using (MM_Blackstart_Display bDisp = new MM_Blackstart_Display(State[1] as Network_Map))
            {
                ...
                if (Target != null && fI != null)
                {
                    ...
                    for (int a = 0; a < Elems.Length; a++)
                        try
                        {
                            ...
                            if (Data_Integration.MMServer != null && Array.IndexOf(Data_Integration.MMServer.UserOperatorships, 999999) == -1 && Array.IndexOf(Data_Integration.MMServer.UserOperatorships, Elems[a].AssociatedElement.Operator.TEID) == -1)
            ...
            foreach (TreeNode tnCorridor in tvSummary.Nodes)
            {
                ...
                foreach (TreeNode tnTarget in tnCorridor.Nodes)
                {
                    ...
                    foreach (TreeNode tnPriSec in tnTarget.Nodes)
                    {
                        ...
                        tnPriSec.Text = LineCollection.Key + " (" + (Energized * 100 / LineCollection.Value.Length).ToString() + "%)";
