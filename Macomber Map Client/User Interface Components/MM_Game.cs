...
namespace Macomber_Map.User_Interface_Components
{
    ...
    public partial class MM_Game : MM_Form
    {
        ...
        public Network_Map_GDI NetworkMap;
        ...
        /// </summary>
        public MM_Game(Network_Map_GDI NetworkMap)
        {
            ...
            try
            {
                ...
                if (QuestionType == 1)
                {
                    ...
                    for (int a = 0; a < 4; a++)
                        while (Elems[a] == null)
                        {
                            ...
                            if (a == 0 && Sub.Units != null && Sub.Units.Length > 0 && Sub.Units[0].UnitType.Name == "Wind" && Sub.LongName.IndexOf("Wind", StringComparison.CurrentCultureIgnoreCase) == -1)
                                Elems[a] = Sub;
                            else if (a != 0 && Sub.Units != null && Sub.Units.Length > 0 && Sub.Units[0].UnitType.Name != "Wind")
                                Elems[a] = Sub;
                        }
                }
                ...
                else if (QuestionType == 2 || QuestionType == 12)
                {
                    ...
                    for (int a = 0; a < 4; a++)
                        ...
                        {
                            MM_Substation Sub = Subs[rnd.Next(Subs.Count)];
                            if (a == 0 && Sub.Units != null && Sub.Units.Length > 0)
                            {
                                if (QuestionType == 2)
                                    Elems[a] = Sub;
                                else
                            ...
                            else if (a != 0 && Sub.Units != null && Sub.Units.Length > 0 && Sub.LongName.IndexOf(FoundQSE.Name, StringComparison.CurrentCultureIgnoreCase) == -1)
                            {
                                bool FoundOne = false;
