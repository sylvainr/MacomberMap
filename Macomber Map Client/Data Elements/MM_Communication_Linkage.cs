...
/*
 String LblName = (string)dr["ID"];
                if (LblName == "ICCPLINK_A_QSE")
                    OutRow = "QSE_Taylor";
                else if (LblName == "ICCPLINK_B_QSE")
                    OutRow = "QSE_Austin";
                else if (LblName == "ICCPLINK_A_TSP")
                    OutRow = "TSP_Taylor";
                else if (LblName == "ICCPLINK_B_TSP")
                    OutRow = "TSP_Austin";
                else if (LblName.Contains("_QSE") && LblName.EndsWith("_A"))
                    OutRow = "QSE_Taylor";
                else if (LblName.Contains("_QSE"))
                    OutRow = "QSE_Austin";
                else if (LblName.Contains("_TSP") && LblName.EndsWith("_A"))
                    OutRow = "TSP_Taylor";
                else if (LblName.Contains("TSP_") && LblName.EndsWith("_A"))
                    OutRow = "TSP_Taylor";
                else if (LblName.Contains("_TSP") || LblName.Contains("TSP_"))
                    OutRow = "TSP_Austin";
                else if (LblName.Contains("TSP_") && LblName.EndsWith("AUSTIN"))
                    OutRow = "TSP_Austin";
                else
                    OutRow = "Other";*/