...
namespace Macomber_Map.Data_Elements.Weather
{
    /// <summary>
    ...
    public class MM_WeatherStation: MM_Serializable
    {
        ...
        public MM_WeatherStation(XmlElement xE)
        {
            ...
            if (xE["lon"] != null && xE["lat"] != null)
                this.LatLng = new PointF(ConvertToSingle(xE["lon"].InnerText), ConvertToSingle(xE["lat"].InnerText));
            ...
            if (xE.HasAttribute("Coordinates"))
                this.LatLng = new PointF(MM_Converter.ToSingle(xE.Attributes["Coordinates"].Value.Split(',')[0]), MM_Converter.ToSingle(xE.Attributes["Coordinates"].Value.Split(',')[1]));
        ...
        public String XMLString
        {
            get
            {
                ...
                OutStr.Append(" Coordinates=\"" + LatLng.X + "," + LatLng.Y + "\"");
